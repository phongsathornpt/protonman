...
var builtinMetadata = map[string]callMetadata{
	...
	"wait_agent":         {Metadata: Metadata{Name: "wait_agent", Kind: KindAgent, DisplayName: "Wait agent"}, title: titleAgentID("Wait for agent", "Wait for agent"), target: targetAgentID},
