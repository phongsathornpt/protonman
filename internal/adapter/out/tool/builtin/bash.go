...
func (bashHandler) Definition() tool.Definition {
	return tool.Definition{
		Name:                   "bash",
		Description:            "Execute external programs, builds, tests, package managers, and shell workflows. Use read for known workspace artifacts; use read with view=source, grep, find_files, and list_dir for repository evidence; use dedicated edit tools for direct file mutations.",
