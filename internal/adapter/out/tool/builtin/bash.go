...
func (bashHandler) Definition() tool.Definition {
	return tool.Definition{
		Name:                   "bash",
		Description:            "Execute external programs, builds, tests, package managers, and shell workflows. Use read_file for known workspace artifacts; use inspect_code, grep, find_files, and list_dir for repository evidence; use dedicated edit tools for direct file mutations.",
