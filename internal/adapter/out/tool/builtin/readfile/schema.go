...
func (readFileHandler) Definition() tool.Definition {
	return tool.Definition{
		Name:                "read_file",
		Description:         "Read and inspect workspace artifacts. Text keeps byte/line pagination and SHA-256 evidence; image and explicit structured views provide bounded pure-Go analysis. Prefer this over shell or language-runtime scripts used only to inspect files.",
