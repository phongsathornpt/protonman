...
func DefaultLimits() Limits {
	return Limits{
		...
		MaxConcurrentDiscovery: 8, MaxConcurrentCallsPerServer: 4,
	}
}
...
func (l Limits) validate() error {
	if l.MaxServers <= 0 || l.MaxToolsPerServer <= 0 || l.MaxTotalTools <= 0 ||
		...
		l.MaxStructuredBytes <= 0 || l.MaxStderrBytes <= 0 || l.MaxConcurrentDiscovery <= 0 || l.MaxConcurrentCallsPerServer <= 0 {
