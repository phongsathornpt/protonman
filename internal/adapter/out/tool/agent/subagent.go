...
func subagentInputSchema() map[string]any {
	return map[string]any{
		...
		"properties": map[string]any{
			...
			"timeoutSeconds": map[string]any{"type": "integer", "minimum": 0, "maximum": 86400, "description": "Optional child runtime timeout for spawn or bounded diagnostic timeout for wait"},
			"agentId":        map[string]any{"type": "string", "description": "Target agent for get, cancel, or resume"},
		},
