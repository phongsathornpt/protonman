...
// Unicode profile preserves Protonman's current terminal-safe glyphs.
const (
	UnicodePrompt      = "› "
	UnicodeMark        = "› "
	UnicodeTool        = "$ "
...
// ASCII profile is safe for dumb terminals, redirected output, and log sinks.
const (
	ASCIIPrompt      = "> "
	ASCIIMark        = "> "
	ASCIITool        = "$ "
...
// Nerd Font profile uses Codicons from Nerd Fonts v3.5.1. Protonman documents
// Nerd Font Mono as the supported terminal variant so these PUA glyphs retain
// the single-cell layout contract expected by the TUI.
const (
