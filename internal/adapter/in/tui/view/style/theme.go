...
var (
	...
	PromptDividerIdle    = lipgloss.NewStyle().Foreground(ColorBorder)
	PromptDividerFocus   = lipgloss.NewStyle().Foreground(ColorBorderFocus)
	PromptDividerWarning = lipgloss.NewStyle().Foreground(ColorWarning)
	PromptDividerError   = lipgloss.NewStyle().Foreground(ColorDanger)
	TodoPendingStyle     = lipgloss.NewStyle().Foreground(ColorTextMuted)
	TodoActiveStyle      = lipgloss.NewStyle().Foreground(ColorFocus)
	TodoCompletedStyle   = lipgloss.NewStyle().Foreground(ColorSuccess)
	TodoSelectedStyle    = lipgloss.NewStyle().Bold(true).Foreground(ColorTextPrimary)
	ModalBorderStyle     = lipgloss.NewStyle().Foreground(ColorBorder)
	ModalFocusStyle      = lipgloss.NewStyle().Foreground(ColorBorderFocus)
