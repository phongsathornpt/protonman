...
var builtinRegistry = mustRegistry(
	Profile{
		...
		AgentPolicy: AgentPolicy{PromptHints: []string{
			...
			"Use read_file with view=source for bounded multi-file source inspection; use grep, find_files, and list_dir for repository discovery; reserve bash for actual programs, builds, tests, and shell workflows.",
