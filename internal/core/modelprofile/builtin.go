...
var builtinRegistry = mustRegistry(
	Profile{
		...
		AgentPolicy: AgentPolicy{PromptHints: []string{
			...
			"Use read with view=source for bounded multi-file source inspection; use grep, find, and ls for repository discovery; use calculate for deterministic arithmetic; reserve bash for actual programs, builds, tests, and shell workflows.",
