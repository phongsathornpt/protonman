...
- `prompt/` composes capability-driven system prompts using deterministic, cache-aware ordered sections. The managed prompt currently uses Prompt ABI v10; see [`system-prompt.md`](system-prompt.md) for ordering and prefix-cache invariants.
